...
export class SearchPipe implements PipeTransform {
  ...
  transform(items: any[], searchText: string): any {
    ...
    return items.filter(it => {
      return this.removeDiacritics(it.toString().toLowerCase()).includes(searchText);
    });
  }

  public removeDiacritics(str:any): string {
    // tslint:disable-next-line:typedef
    return str.replace(/[^\u0000-\u007E]/g, function(this: any, a: any) {
